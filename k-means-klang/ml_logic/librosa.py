...
# ----------------------------------------------------------------------------------------
# OPTION FOR MORE FETCHING MULTIPLE FILES IN MULTIPLE SUBFOLDERS 
# ----------------------------------------------------------------------------------------


#defining a function to extract features form audio files 🚨still tp be updated
def multiple_file_extract_features(file_path):
    ''' 
    Using librosa to load the audio files(s) from multiple folders and extracting key features to later be stored in a dataframe
    '''
...
# 🚨Note!!! Just jibberish code for now. Needs to be updated and included these into the function above 
# -----------------------------------------------------------------
